...
Note: How to add special tokens to Qwen2.5:
  download our model checkpoint with special tokens added: https://huggingface.co/OneVLA/Qwen2.5-VL-3B-Instruct-Action
  or /OneVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md （adpat a little code)
...
from OneVLA.model.modules.action_model.MLP_ActionHeader import get_action_model
...
if __name__ == "__main__":
    ...
    # from OneVLA.dataloader.lerobot_datasets import get_vla_dataset, collate_fn
