...
_ACTION_TOKEN_MAX = 153984 # here only for fast_tokenizer, see OneVLA/model/modules/vlm/tools/add_qwen_special_tokens/README.md
...
class _QWen3_VL_Interface(nn.Module):
    ...
    def __init__(self, config: Optional[dict] = None, **kwargs):
        ...
        attn_impl = os.environ.get("ONEVLA_ATTN_IMPL", None) or qwenvl_config.get("attn_implementation", "flash_attention_2")
